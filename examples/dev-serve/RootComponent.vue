<script setup lang="ts">
	...
	const controlPosition = ref('top-left');
	const showMap = ref(true);
	const center = [ 10.288107, 49.405078 ];
	const zoom = 3;
	const useClasses = true;
	...
	const buttonIcon = mdiCursorDefaultClick;
	...
	onMounted(() => {
		...
		setInterval(() => (geoJsonSource.show.value = !geoJsonSource.show.value), 1000);
	});
</script>
